...
load ME03tRfall
load ME25tRFall
bb=normalization3 (ME25fstack);
% d = ME03PSV_pick;
ccc=RFtaxis4b;
plot(tt(1:181),cc4norm(1:181),'linewidth',3); hold on
plot(ccc(1000:4000),bb(1000:4000),'LineWidth',3); hold off
xlabel('Time (s)');
ylabel('Amplitude');
ylim([-1 1]);
...
% load ME03tRfall
% load ME36tRFall
% bb=normalization3 (ME36fstack);
% % d = ME03PSV_pick;
% ccc=RFtaxis4b;
% plot(tt(1:181),cc4norm(1:181),'linewidth',3); hold on
% plot(ccc(1000:4000),bb(1120:4120),'LineWidth',3); hold off
% xlabel('Time (s)');
% ylabel('Amplitude');
% ylim([-1 1]);
% legend('Synthetic','Real');